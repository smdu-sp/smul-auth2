...
export const ServidorOrderByRelevanceFieldEnum = {
  id: 'id',
  ip: 'ip',
  nome: 'nome'
} as const

export type ServidorOrderByRelevanceFieldEnum = (typeof ServidorOrderByRelevanceFieldEnum)[keyof typeof ServidorOrderByRelevanceFieldEnum]
